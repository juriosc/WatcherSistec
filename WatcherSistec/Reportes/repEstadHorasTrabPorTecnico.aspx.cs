...
{
    public partial class repEstadHorasTrabPorTecnico : System.Web.UI.Page
    {
        ...
        private void Listar_Reporte()
        {
            ...
            List<beReportes> lbeReportes = br.ListarReporte_Estadistico_HorasTrabxTecnico(BeginDate, EndDate, txtProveedor.Text.ToString(), txtTecnico.Text.ToString());
